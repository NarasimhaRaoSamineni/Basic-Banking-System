...
<head>
	...
	<a href="transfer_to.php">
		<button class="glow-on-hover" style="background-color: transparent; color:antiquewhite"> Transfer To</button>
	</a>
	</div>
	<br>
	<br>
    ...
    <div class="buttons">
		...
		<button class="glow-on-hover" style="background-color: transparent; color:antiquewhite">Mini Statement</button>
		</a>
	</div>
